...
User.create!(
  ...
  gender: 1,
  profile_photo: open("#{Rails.root}/db/dummy_images/1.jpg")
)
User.create!(
  ...
  gender: 1,
  profile_photo: open("#{Rails.root}/db/dummy_images/2.jpg")
)
User.create!(
  ...
  gender: 1,
  profile_photo: open("#{Rails.root}/db/dummy_images/3.jpg")
)
User.create!(
  ...
  gender: 0,
  profile_photo: open("#{Rails.root}/db/dummy_images/4.jpg")
)
User.create!(
  ...
  gender: 0,
  profile_photo: open("#{Rails.root}/db/dummy_images/5.jpg")
)
User.create!(
  ...
  gender: 0,
  profile_photo: open("#{Rails.root}/db/dummy_images/6.jpg")
)
